...
keywords:
  ...
  - cache penetration
---
Cache is one of the most important part when developing highly available application. It provides a high-performance way to fetch frequently accessed data and reduce traffic to our database.
